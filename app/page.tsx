  ...
  return (
    <main id="main-content" className="bg-white font-[family-name:var(--font-pretendard)]">
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
            {categories.map((cat, idx) => {
              const iconColors = [
                'bg-coral-50 text-coral-500 group-hover:bg-coral-500',
                'bg-ocean-50 text-ocean-500 group-hover:bg-ocean-500',
                'bg-gold-50 text-gold-500 group-hover:bg-gold-500',
                'bg-fresh-50 text-fresh-600 group-hover:bg-fresh-500',
                'bg-warm-100 text-coral-400 group-hover:bg-coral-400',
              ];
              const colorClass = iconColors[idx % iconColors.length];
              return (
              <Link key={cat.id} href={`/products/${cat.slug}`}
                className="group relative overflow-hidden rounded-2xl border border-gray-100 bg-gradient-to-b from-white to-gray-50 p-6 text-center transition-all duration-500 hover:border-gold-300 hover:shadow-xl hover:shadow-gold-500/5 hover:-translate-y-1">
      ...
      {!loading && featuredProducts.length > 0 && (
        <section className="border-t border-gray-100 bg-gradient-to-b from-white to-warm-50 py-24">
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
      ...
      <section className="border-y border-gray-100 bg-gradient-to-br from-gold-50 via-warm-50 to-coral-50 py-24">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="flex flex-col items-center gap-10 md:flex-row md:gap-16">
            <div className="flex-1">
              <span className="inline-flex items-center gap-2 rounded-full border border-gold-500/30 bg-gold-500/10 px-4 py-1.5 text-sm font-semibold tracking-wider text-gold-500">
      ...
      {/* ── Value Propositions ── */}
      <section className="border-t border-gray-100 bg-fresh-50/50 py-24">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={item.title} className="flex items-start gap-4 rounded-2xl bg-white p-6 ring-1 ring-gray-100 transition-all hover:shadow-md hover:ring-fresh-200">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-fresh-50 text-fresh-600">
                  {item.icon}
                </div>
                <div>
      ...
      {loading && (
        <div className="flex items-center justify-center py-20">
          <div className="text-center">
            ...
            <p className="text-base text-gray-500">상품 로딩 중...</p>
          </div>
        </div>
      )}
